...
public sealed class UiText : IUiText
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ...
        ["billing.title"] = T("Billing & subscription", "Pengebilan & langganan", "账单与订阅", "பில்லிங் & சந்தா"),
        ["billing.sub"] = T(
            "Manage your plan, view invoices and upgrade your household.",
            "Urus pelan anda, lihat invois dan naik taraf isi rumah anda.",
            "管理您的套餐、查看发票并升级您的家庭账户。",
            "உங்கள் திட்டத்தை நிர்வகிக்கவும், விலைப்பட்டியல்களைப் பார்க்கவும், உங்கள் குடும்பத்தை மேம்படுத்தவும்."),
        ["billing.loading"] = T("Loading billing…", "Memuatkan pengebilan…", "正在加载账单…", "பில்லிங் ஏற்றுகிறது…"),
        ["billing.error"] = T(
            "We couldn't load your billing details. Please try again.",
            "Kami tidak dapat memuatkan butiran pengebilan anda. Sila cuba lagi.",
            "无法加载您的账单详情，请重试。",
            "உங்கள் பில்லிங் விவரங்களை ஏற்ற முடியவில்லை. மீண்டும் முயற்சிக்கவும்."),
        ["billing.renews"] = T("renews {0}", "diperbaharui {0}", "{0} 续订", "{0} புதுப்பிக்கப்படும்"),
        ["billing.invoices"] = T("Invoices", "Invois", "发票", "விலைப்பட்டியல்கள்"),
        ["billing.no_invoices"] = T("No invoices yet.", "Tiada invois lagi.", "暂无发票。", "இன்னும் விலைப்பட்டியல்கள் இல்லை."),
        ["billing.col.number"] = T("Number", "Nombor", "编号", "எண்"),
        ["billing.col.status"] = T("Status", "Status", "状态", "நிலை"),
        ["billing.col.amount"] = T("Amount", "Jumlah", "金额", "தொகை"),
        ["billing.col.issued"] = T("Issued", "Dikeluarkan", "开具日期", "வழங்கப்பட்டது"),
        ["billing.col.paid"] = T("Paid", "Dibayar", "支付日期", "செலுத்தப்பட்டது"),
        ["billing.col.actions"] = T("Actions", "Tindakan", "操作", "செயல்கள்"),
        ["billing.view"] = T("View", "Lihat", "查看", "பார்"),
        ["billing.no_subscription"] = T(
            "You don't have an active subscription. Choose a plan below to get started.",
            "Anda tiada langganan aktif. Pilih pelan di bawah untuk bermula.",
            "您还没有有效订阅。请选择下面的套餐开始使用。",
            "உங்களிடம் செயலில் உள்ள சந்தா இல்லை. தொடங்க கீழே ஒரு திட்டத்தைத் தேர்வுசெய்க."),
        ["billing.plans"] = T("Available plans", "Pelan tersedia", "可选套餐", "கிடைக்கும் திட்டங்கள்"),
        ["billing.promo_placeholder"] = T("Promo or gift code", "Kod promosi atau hadiah", "优惠或礼品码", "விளம்பர அல்லது பரிசு குறியீடு"),
        ["billing.apply"] = T("Apply", "Guna", "应用", "பயன்படுத்து"),
        ["billing.checking"] = T("Checking…", "Menyemak…", "检查中…", "சரிபார்க்கிறது…"),
        ["billing.subscribe"] = T("Subscribe", "Langgan", "订阅", "சந்தா செலுத்து"),
        ["billing.switch_plan"] = T("Switch plan", "Tukar pelan", "切换套餐", "திட்டத்தை மாற்று"),
        ["billing.promo_applied"] = T(
            "✓ {0}% discount will be applied at checkout.",
            "✓ Diskaun {0}% akan digunakan semasa pembayaran.",
            "✓ 结账时将享受 {0}% 折扣。",
            "✓ {0}% தள்ளுபடி பணம் செலுத்தும்போது பயன்படுத்தப்படும்."),
        ["billing.promo_expired"] = T("That code has expired.", "Kod itu telah tamat tempoh.", "该代码已过期。", "அந்தக் குறியீடு காலாவதியாகிவிட்டது."),
        ["billing.promo_exhausted"] = T("That code has reached its redemption limit.", "Kod itu telah mencapai had penebusan.", "该代码已达兑换上限。", "அந்தக் குறியீடு அதன் மீட்பு வரம்பை எட்டிவிட்டது."),
        ["billing.promo_invalid"] = T("That code isn't valid.", "Kod itu tidak sah.", "该代码无效。", "அந்தக் குறியீடு செல்லாது."),
        ["billing.promo_error"] = T("We couldn't check that code. Please try again.", "Kami tidak dapat menyemak kod itu. Sila cuba lagi.", "无法验证该代码，请重试。", "அந்தக் குறியீட்டைச் சரிபார்க்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்."),
